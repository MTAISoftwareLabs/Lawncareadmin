...
export const siteSettings = pgTable("site_settings", {
  ...
  heroButtonText: varchar("hero_button_text", { length: 100 }).default("Start Your 7-Day Free Trial"),
  heroBadgeText: varchar("hero_badge_text", { length: 150 }).default("Built for Cool-Season Lawns"),
